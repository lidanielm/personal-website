    ...
    return (
        <div className="wrapper intro">
            ...
            <div style={{marginBottom: "10px"}}>
                <a href="mailto:dli2004@seas.upenn.edu">
                    <FontAwesomeIcon icon={faEnvelope} className="contact-icon-header"/>
                </a>
                <a href="https://www.linkedin.com/in/lidanielm/">
                    <svg fill="#000000" height="25px" width="60px" version="1.1" id="Layer_1" viewBox="0 0 310 310" color="#696969">
                    <g id="XMLID_801_">
                ...
                <a href="https://github.com/lidanielm">
                    <svg fill="#000000" width="25px" height="25px" version="1.1" viewBox="0 0 100 100">
